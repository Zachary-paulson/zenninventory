        ...
        <div className="row makeFixed">
          <div className="col nav-col" activekey={this.state.key} onSelect={key => this.setState({ key})}>
            <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a className={window.location.pathname === "/dashboard" ? "nav-link active" : "nav-link"} eventkey="dashboard" id="v-pills-dashboard-tab" data-toggle="pill" href="/dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="false">Dashboard</a>
              ...
              <a className={window.location.pathname === "/productdetail" ? "nav-link active" : "nav-link"} eventkey="productdetail" id="v-pills-productdetail-tab" data-toggle="pill" href="/productdetail" role="tab" aria-controls="v-pills-productdetail" aria-selected="false">Product Detail</a>
