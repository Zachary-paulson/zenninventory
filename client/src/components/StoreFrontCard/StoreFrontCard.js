...
class StoreFrontCard extends Component {
  ...
  render() {
    ...
    return (<div className='continer-fuild'>
      <div className="card StoreFrontCard">
        <div className="card-body">
          <h5 className="card-title">{this.props.storeFront} Store front</h5>
          <p className="card-text">Connect your {this.props.storeFront} Store Front with Zenn Inventory
          </p>
          <a href="#" className="btn btn-primary">Connect to
